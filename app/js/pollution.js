...
function h1() {
  ...
  var qArray = [`select city_name from manika.is_polluted_by where symbol= 'SO2' and po_date>='01-JAN-15' and po_date<='31-DEC-15' and max_value = (select max(max_value) from manika.is_polluted_by where symbol= 'SO2' and po_date>='01-JAN-15' and po_date<='31-DEC-15')`,`select avg(mean_value) from manika.is_polluted_by where symbol = 'CO' and city_name = 'Philadelphia' and po_date>='01-JAN-14' and po_date<='31-DEC-14'`,`select max_value from manika.is_polluted_by where symbol = 'NO2' and city_name = 'Denver' and po_date ='12-MAR-14'`,`select symbol from manika.is_polluted_by where mean_value = (select max(mean_value) from manika.is_polluted_by)`,`select symbol from (select symbol, max(mean_value) as m from manika.is_polluted_by where city_name ='Los Angeles' and po_date>='01-MAR-14' and po_date<='31-MAR-14' group by symbol) where m = (select max(m) from (select symbol, max(mean_value) as m from manika.is_polluted_by where city_name ='Los Angeles' and po_date>='01-MAR-14' and po_date<='31-MAR-14' group by symbol))`];
